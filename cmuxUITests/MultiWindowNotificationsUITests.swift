...
final class MultiWindowNotificationsUITests: XCTestCase {
    ...
    private func resolveCmuxCLIPaths(strategy: CmuxCLIStrategy) -> [String] {
        ...
        candidates.append("/tmp/cmux-\(launchTag)/Build/Products/Debug/amux DEV.app/Contents/Resources/bin/cmux")
    ...
    private func appendCLIPathCandidates(
        ...
        candidates.append("\(productsDir)/amux DEV.app/Contents/Resources/bin/cmux")
