...
@Suite struct SocketControlSettingsTests {
    ...
    @Test func taggedDevBuildDetection() {
        #expect(SocketControlSettings.isTaggedDevBuild(bundleIdentifier: "com.open330.amux.debug.my-tag"))
        #expect(!SocketControlSettings.isTaggedDevBuild(bundleIdentifier: "com.open330.amux.debug"))
        #expect(!SocketControlSettings.isTaggedDevBuild(bundleIdentifier: "com.open330.amux"))
    }
