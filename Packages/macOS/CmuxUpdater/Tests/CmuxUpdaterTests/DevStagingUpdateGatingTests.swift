...
@Suite struct DevStagingUpdateGatingTests {
    ...
    @Test func classifiesDebugAndStagingBundlesAsDevLike() {
        #expect(UpdateController.isDevLikeBundleIdentifier("com.open330.amux.debug"))
        #expect(UpdateController.isDevLikeBundleIdentifier("com.open330.amux.debug.my-tag"))
        #expect(UpdateController.isDevLikeBundleIdentifier("com.open330.amux.staging"))
        #expect(UpdateController.isDevLikeBundleIdentifier("com.open330.amux.staging.my-tag"))
    }

    @Test func doesNotClassifyPublicOrNightlyOrNilAsDevLike() {
        #expect(!UpdateController.isDevLikeBundleIdentifier("com.open330.amux"))
        ...
        #expect(!UpdateController.isDevLikeBundleIdentifier("com.open330.amux.debugger"))
        #expect(!UpdateController.isDevLikeBundleIdentifier("com.open330.amux.stagingx"))
    }
