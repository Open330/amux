            ...
            SettingsCard {
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.theme) {
                        Text(String(localized: "sleepyMode.theme.cmux", defaultValue: "amux")).tag(SleepyTheme.cmux)
                ...
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.mascot) {
                        Text(String(localized: "sleepyMode.mascot.cmux", defaultValue: "amux mascot")).tag(SleepyMascot.cmux)
                ...
                SettingsCardRow(
                    ...
                    Picker("", selection: $store.glow) {
                        ...
                        Text(String(localized: "sleepyMode.glow.cmux", defaultValue: "amux")).tag(SleepyGlow.cmux)
