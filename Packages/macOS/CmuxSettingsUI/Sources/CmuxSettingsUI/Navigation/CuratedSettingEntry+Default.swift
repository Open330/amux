...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "supported-file-previews", title: String(localized: "settings.app.openSupportedFilesInCmux", defaultValue: "Open Supported Files in amux"), synonyms: "app.openSupportedFilesInCmux cmd click file preview pdf image video audio quicklook quick look editor external"),
            .init(section: .app, id: "markdown-viewer", title: String(localized: "settings.app.openMarkdownInCmuxViewer", defaultValue: "Open Markdown in amux Viewer"), synonyms: "app.openMarkdownInCmuxViewer md markdown mdx viewer preview readme"),
            ...
            .init(
                ...
                detailText: [
                    String(localized: "settings.terminal.memoryGuardrail.subtitleOn", defaultValue: "amux warns you with a badge and a banner when one pane's process tree uses too much memory, so a single leak can't crash the whole app."),
            ...
            .init(section: .sidebarAppearance, id: "open-pr-links", title: String(localized: "settings.app.openSidebarPRLinks", defaultValue: "Open Sidebar PR Links in amux Browser"), synonyms: "sidebar.openPullRequestLinksInCmuxBrowser pr links github browser default external embedded"),
            .init(section: .sidebarAppearance, id: "open-port-links", title: String(localized: "settings.app.openSidebarPortLinks", defaultValue: "Open Sidebar Port Links in amux Browser"), synonyms: "sidebar.openPortLinksInCmuxBrowser ports localhost links browser default external embedded"),
            ...
            // Browser
            .init(section: .browser, id: "enable-browser", title: String(localized: "settings.browser.enabled", defaultValue: "Enable amux Browser"), synonyms: "browser.disabled enable disable webview embedded browser tabs links"),
            ...
            .init(section: .browser, id: "terminal-links", title: String(localized: "settings.browser.openTerminalLinks", defaultValue: "Open Terminal Links in amux Browser"), synonyms: "browser.openTerminalLinksInCmuxBrowser click url terminal links open in browser href"),
