...
APP="$HOME/Library/Developer/Xcode/DerivedData/cmux-${TAG_SLUG}/Build/Products/Debug/amux DEV ${TAG}.app"
BID="com.open330.amux.debug.${TAG_ID}"
...
sleep 0.5
pkill -f "amux DEV ${TAG}.app/Contents/MacOS/amux DEV" || true
rm -f "$SOCK" "$DSOCK"
sleep 0.5
