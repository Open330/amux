...
class CmuxPerfRunner:
    def __init__(self, args: argparse.Namespace):
        ...
        self.binary_path = self.app_path / "Contents/MacOS/amux DEV"
    ...
    def default_app_path(self) -> pathlib.Path:
        return pathlib.Path.home() / (
            ...
            f"Build/Products/Debug/amux DEV {self.tag_slug}.app"
        )
    ...
    def clean_persisted_state(self) -> None:
        ...
        bundle_id = f"com.open330.amux.debug.{self.tag_id}"
        ...
        env.update(
            {
                ...
                "CMUX_TAG": self.tag,
                "CMUX_BUNDLE_ID": f"com.open330.amux.debug.{self.tag_id}",
            }
        )
        return env
    ...
    def cli_env(self) -> dict[str, str]:
        ...
        env["CMUX_BUNDLE_ID"] = f"com.open330.amux.debug.{self.tag_id}"
        ...
        if proc and proc.poll() is None:
            ...
            try:
                ...
                try:
                    ...
                    pass
        subprocess.run(
            ["pkill", "-f", re.escape(f"amux DEV {self.tag_slug}.app/Contents/MacOS/amux DEV")],
