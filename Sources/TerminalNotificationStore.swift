...
final class TerminalNotificationStore: ObservableObject {
    ...
    func sendSettingsTestNotification() {
        ...
        ensureAuthorization(origin: .settingsTest) { [weak self] authorized, _ in
            ...
            content.title = String(
                localized: "notifications.settingsTest.title",
                defaultValue: "amux test notification"
            )
            content.body = String(
    ...
    func reportNotificationHookFailure(_ failure: TerminalNotificationPolicyFailure) {
        ...
        ensureAuthorization(origin: .notificationDelivery) { [weak self] authorized, _ in
            ...
            let format = String(
                ...
                defaultValue: "amux used default notification behavior because '%@' failed."
            )
            let content = UNMutableNotificationContent()
            content.title = title
    ...
    private func resolvedNotificationTitle(for notification: TerminalNotification) -> String {
        let appName = Bundle.main.object(forInfoDictionaryKey: "CFBundleDisplayName") as? String
            ...
            ?? String(localized: "about.appName", defaultValue: "amux")
    ...
    private func presentNotificationSettingsPrompt(attempt: Int) {
        ...
        alert.messageText = String(localized: "dialog.enableNotifications.title", defaultValue: "Enable Notifications for amux")
        alert.informativeText = String(localized: "dialog.enableNotifications.message", defaultValue: "Notifications are disabled for amux. Enable them in System Settings to see alerts.")
