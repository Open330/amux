...
enum MarkdownFontFamily {
    /// UserDefaults / amux.json key (`markdown.fontFamily`).
    ...
    /// collapse to spaces so a malformed amux.json value cannot produce invalid
    /// multiline CSS.
    ...
    /// UserDefaults / amux.json and falling back to the System default.
