        ...
        case .destinationProfileNotFound(let query):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "No amux browser profile matches '%@'"
                ),
                query
            )
        case .destinationProfileCreationFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to create amux browser profile '%@'"
                ),
                name
            )
        }
        ...
        case .ambiguousProfile(let query):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Multiple amux browser profiles match '%@'. Use the profile ID instead."
                ),
                query
            )
        ...
        case .profileRenameFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to rename amux browser profile to '%@'"
                ),
                name
            )
        case .cannotDeleteDefaultProfile:
        ...
        case .profileInUse(let name, let count):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Cannot delete amux browser profile '%@' while %d browser panel(s) are using it"
                ),
                name,
                count
            )
        case .profileDeleteFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to delete amux browser profile '%@'"
                ),
                name
            )
        case .profileClearFailed(let name):
            return String.localizedStringWithFormat(
                String(
                    ...
                    defaultValue: "Failed to clear amux browser profile '%@'"
                ),
                name
            )
        }
