...
private let tabManagerLogger = Logger(subsystem: "com.open330.amux", category: "TabManager")
        ...
        if let terminalPanel = workspace.focusedTerminalPanel,
           terminalPanel.surface.surface != nil {
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
                ...
                terminalPanel.sendText("amux welcome\n")
            }
            return
        }
...
extension Notification.Name {
    ...
    static let commandPaletteAmuxSessionSwitcherRequested = Notification.Name("amux.commandPaletteSessionSwitcherRequested")
