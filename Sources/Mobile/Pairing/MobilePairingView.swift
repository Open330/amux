...
struct MobilePairingView: View {
    ...
    /// amux does not currently distribute the inherited iPhone companion app.
    private static let iphoneAppURL = URL(string: "https://github.com/Open330/amux")!
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 2) {
            ...
            Text(String(localized: "mobile.pairing.window.subheading", defaultValue: "Scan this code with the amux app on your iPhone to sync your terminal workspaces."))
                .cmuxFont(.callout)
    ...
    private var signInRow: some View {
        requirementRow(
            title: String(localized: "mobile.pairing.req.signIn.title", defaultValue: "Signed in to amux"),
    ...
    private var signedOut: some View {
        VStack(spacing: 12) {
            ...
            Text(String(localized: "mobile.pairing.signIn.prompt", defaultValue: "Sign in with your amux account to pair your iPhone."))
                .multilineTextAlignment(.center)
                .foregroundStyle(.secondary)
                .fixedSize(horizontal: false, vertical: true)
    ...
    private var steps: some View {
        VStack(alignment: .leading, spacing: 10) {
            step(1, String(localized: "mobile.pairing.step.install", defaultValue: "Install amux on your iPhone and open it."))
            HStack(spacing: 4) {
                Spacer(minLength: 30)
                Text(String(localized: "mobile.pairing.getApp.prompt", defaultValue: "Don't have it yet?"))
                    ...
                    .foregroundStyle(.secondary)
                Link(
                    String(localized: "mobile.pairing.getApp.link", defaultValue: "Get amux for iPhone"),
