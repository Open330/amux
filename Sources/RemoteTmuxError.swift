    ...
    var message: String {
        ...
        case let .unsupportedTmux(detected):
            let format = String(
                ...
                defaultValue: "remote session server is too old (found %@; amux needs version %@ or newer)"
            )
            return String(
                format: format,
