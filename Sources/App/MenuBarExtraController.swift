...
final class MenuBarExtraController: NSObject, NSMenuDelegate {
    ...
    private let menu = NSMenu(title: "amux")
    ...
    private let showMainWindowItem = NSMenuItem(title: String(localized: "statusMenu.showCmux", defaultValue: "Show amux"), action: nil, keyEquivalent: "")
    ...
    init(
        ...
        if let button = statusItem.button {
            ...
            button.toolTip = String(localized: "statusMenu.tooltip.none", defaultValue: "amux")
        }
    ...
    private func refreshUI(snapshot: NotificationMenuSnapshot) {
        ...
        if let button = statusItem.button {
            ...
            button.toolTip = displayedUnreadCount == 0
                ? String(localized: "statusMenu.tooltip.none", defaultValue: "amux")
                : displayedUnreadCount == 1
                    ? String(localized: "statusMenu.tooltip.unread.oneWithProduct", defaultValue: "amux: 1 unread notification")
                    : String(localized: "statusMenu.tooltip.unread.otherWithProduct", defaultValue: "amux: \(displayedUnreadCount) unread notifications")
        }
    }
