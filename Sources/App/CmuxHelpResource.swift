...
enum CmuxHelpResource {
    ...
    var url: URL {
        switch self {
        case .gettingStarted:
            return URL(string: "https://github.com/Open330/amux#build-from-source")!
        case .concepts:
            return URL(string: "https://github.com/Open330/amux#how-it-fits-together")!
        case .configuration:
            return URL(string: "https://github.com/Open330/amux/blob/main/docs/configuration.md")!
        case .customCommands:
            return URL(string: "https://github.com/Open330/amux/blob/main/docs/configuration.md")!
        case .dock:
            return URL(string: "https://github.com/Open330/amux/blob/main/docs/dock.md")!
        case .keyboardShortcuts:
            return URL(string: "https://github.com/Open330/amux/blob/main/docs/configuration.md")!
        case .apiReference:
            return URL(string: "https://github.com/Open330/amux/blob/main/docs/cli-contract.md")!
        case .browserAutomation:
            return URL(string: "https://github.com/Open330/amux/blob/main/docs/agent-browser-port-spec.md")!
        case .notifications:
            return URL(string: "https://github.com/Open330/amux/blob/main/docs/notifications.md")!
        case .ssh:
            return URL(string: "https://github.com/Open330/amux#readme")!
        case .skills:
            return URL(string: "https://github.com/Open330/amux/tree/main/skills")!
        case .claudeCodeTeams:
            return URL(string: "https://github.com/Open330/amux/blob/main/docs/agent-hooks.md")!
        case .ohMyOpenCode:
            return URL(string: "https://github.com/Open330/amux#readme")!
        case .ohMyCodex:
            return URL(string: "https://github.com/Open330/amux#readme")!
        case .ohMyClaudeCode:
            return URL(string: "https://github.com/Open330/amux#readme")!
        case .changelog:
            return URL(string: "https://github.com/Open330/amux/blob/main/CHANGELOG.md")!
        case .githubIssues:
            return URL(string: "https://github.com/Open330/amux/issues")!
        }
    }
}
