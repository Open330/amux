...
enum SettingsNavigationTarget: String, CaseIterable, Identifiable {
    ...
    var title: String {
        ...
        case .settingsJSON:
            return String(localized: "settings.section.settingsJSON", defaultValue: "amux.json")
        case .reset:
...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.account, "pro", String(localized: "settings.account.pro.title", defaultValue: "amux Pro"), "pro upgrade subscription billing plan pricing cloud"),
        ...
        setting(.app, "supported-file-previews", String(localized: "settings.app.openSupportedFilesInCmux", defaultValue: "Open Supported Files in amux"), "cmd click file preview pdf image audio video quick look editor"),
        ...
        setting(.app, "markdown-viewer", String(localized: "settings.app.openMarkdownInCmuxViewer", defaultValue: "Open Markdown in amux Viewer"), "md markdown viewer"),
        ...
        setting(.sidebarAppearance, "open-pr-links", String(localized: "settings.app.openSidebarPRLinks", defaultValue: "Open Sidebar PR Links in amux Browser"), "pull request link browser"),
        setting(.sidebarAppearance, "open-port-links", String(localized: "settings.app.openSidebarPortLinks", defaultValue: "Open Sidebar Port Links in amux Browser"), "port link browser"),
        ...
        setting(.browser, "enable-browser", String(localized: "settings.browser.enabled", defaultValue: "Enable amux Browser"), "webview tabs links"),
        ...
        setting(.browser, "terminal-links", String(localized: "settings.browser.openTerminalLinks", defaultValue: "Open Terminal Links in amux Browser"), "click links browser"),
        ...
        setting(.settingsJSON, "open-file", String(localized: "settings.settingsJSON.openFile", defaultValue: "Open amux.json"), "config json file editor dotfiles"),
