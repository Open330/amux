        ...
        guard let cliURL,
            ...
            presentStartFailure(
                ...
                action: String(
                    ...
                    defaultValue: "Install or reload a fresh amux build, then try Start Cloud VM again. You can also run `amux vm new` in a terminal to see the full error."
                ),
        ...
        process.terminationHandler = { terminatedProcess in
            ...
            Task { @MainActor in
                ...
                let format = String(
                    ...
                    defaultValue: "amux vm new exited with status %d."
                )
                Self.shared.presentStartFailure(
                    ...
                    action: String(
                        ...
                        defaultValue: "Open a terminal and run `amux auth status`, `amux vm ls`, then `amux vm new`. If you hit the active VM limit, delete one with `amux vm rm <id>` and retry."
                    ),
        ...
        do {
            ...
            presentStartFailure(
                summary: String(
                    ...
                    defaultValue: "amux vm new could not be launched."
                ),
                output: error.localizedDescription,
                action: String(
                    localized: "command.cloudVM.failed.action.launch",
                    defaultValue: "Reload amux so the bundled CLI is available, then try again. If it still fails, run `amux vm new` in a terminal and send us the output."
                ),
                preferredWindow: preferredWindow
            )
            return false
