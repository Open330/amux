        ...
        VStack(alignment: .leading, spacing: 6) {
            Toggle(isOn: $forwardToPhone) {
                VStack(alignment: .leading, spacing: 2) {
                    ...
                    Text(String(localized: "notifications.forwardToPhone.subtitle", defaultValue: "Send agent notifications to the amux iPhone app. Off by default; nothing is uploaded unless this is on."))
                        .cmuxFont(.caption)
