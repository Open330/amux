/**
 * Single source of truth for amux download links.
 *
 * `DOWNLOAD_URL` is the actual release asset. amux ships only a macOS build,
...
export const DOWNLOAD_URL =
  "https://github.com/Open330/amux/releases/latest/download/amux-macos.dmg";
...
export const WAITLIST_EARLY_ACCESS_FLAGS: Record<WaitlistPlatform, string> = {
  linux: "amux-for-linux",
  android: "amux-for-android",
  windows: "amux-for-windows",
};
