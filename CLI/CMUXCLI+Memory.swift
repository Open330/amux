...
extension CMUXCLI {
    ...
    private func buildMemoryPayload(
        ...
        do {
            ...
            throw CLIError(message: String(localized: "cli.memory.error.diagnosticsUnsupported", defaultValue: "amux memory requires a running amux build that supports memory diagnostics"))
        }
    }
