...
extension CMUXCLI {
    ...
    Usage: amux move-tab-to-new-workspace [--tab <id|ref|index>] [--surface <id|ref|index>] [--workspace <id|ref|index>] [--window <id|ref|index>] [--title <text>] [--focus <true|false>]
    ...
    Example:
      amux move-tab-to-new-workspace --tab tab:2
      amux move-tab-to-new-workspace --surface surface:3 --title "build logs"
    """
}
