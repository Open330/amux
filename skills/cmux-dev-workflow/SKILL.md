...
Never run bare `xcodebuild` or open an untagged `amux DEV.app`. Untagged builds share the default debug socket and bundle ID with other agents, causing conflicts and stealing focus.
