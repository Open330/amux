...
```text
App path:
  /absolute/path/to/amux DEV <tag>.app
```
...
Do not open an untagged `amux DEV.app` from DerivedData. It shares the default debug socket and bundle ID with other agents.
