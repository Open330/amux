---
name: cmux-browser
description: End-user browser automation with cmux. Use when you need to open sites, interact with pages, wait for state changes, and extract data from amux browser surfaces.
---
...
amux browser surface:7 fill e1 "hello"
...
amux browser open https://example.com --workspace workspace:2 --window window:1 --json
```
...
amux browser <surface> wait --text "Success" --timeout-ms 10000
...
amux browser surface:7 wait --load-state complete --timeout-ms 15000
amux browser surface:7 snapshot --interactive
amux browser surface:7 fill e1 "Jane Doe"
amux browser surface:7 fill e2 "jane@example.com"
cmux --json browser surface:7 click e3 --snapshot-after
amux browser surface:7 wait --url-contains "/welcome" --timeout-ms 15000
amux browser surface:7 snapshot --interactive
```
...
```bash
amux browser surface:7 fill e11 "" --snapshot-after --json
amux browser surface:7 get value e11 --json
```
...
amux browser surface:7 get html body
```
